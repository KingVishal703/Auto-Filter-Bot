...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7527422922:AAEkatsKiRKyDGTqOgCXDxAJRoOF8kWdC1U')
if len(BOT_TOKEN) == 0:
...
LOG_CHANNEL = environ.get('LOG_CHANNEL', '-1002149374428')
...
SHORTLINK_API = environ.get("SHORTLINK_API", "8cb42dcb724c2b970cc10b098132273359eaf0b8")
...
if len(URL) == 0:
    ...
    if URL.startswith(('https://', 'http://')):
        if not URL.endswith("https://auto-filter-bot-86zl.onrender.com/"):
            URL += '/'
